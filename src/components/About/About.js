...
export default function About(props) {
    return (
        <div>
            ...
            <p>If you're a no-BS kind of person, or a recruiter, here's <a target="_blank" rel="noopener noreferrer" href={pdf}>my resume</a> (no guarantees on how up-to-date it is).</p>
